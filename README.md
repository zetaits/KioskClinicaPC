...
3. **Muestra** — ficha con CPU, RAM, GPU, disco, pantalla, batería, etc. + precio.
...
- **Detección automática** — CPU, núcleos, RAM, GPU, almacenamiento, pantalla, SO, batería, WiFi, cámara y la identidad real (fabricante/modelo). Lo que el equipo no tiene, no se muestra.
- **Precio y marketing** — precio, precio rebajado, tienda, dirección y slides de atracción, todo configurable.
- **Modo kiosko de verdad** — arranca solo con Windows, oculta barra de tareas y bloquea el Administrador de tareas. Nadie se sale sin la contraseña.
